            ...
            <div class="card-body">
                ...
                <hr>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputuname" placeholder="Username" value="Nombre del usuario a editar">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control custom-select">
                            ...
                            <option value="" selected>Femenino</option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <div class="col-lg-6 ">
        <div class="card">
            <div class="card-body">
                    ...
                    <a  class="btn btn-success waves-effect waves-light m-r-10" href="{{ route('admin.usuarios.index')}}">Editar</a>
